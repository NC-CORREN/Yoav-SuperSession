 ...
 *
 * POST /sb/ingress
 *   - body: UreqEnvelope JSON
 *   - returns: IngressDecision (with traceId and stubbed CLIN/CLOUT codes)
 */
@RestController
@RequestMapping("/sb")
public class SwitchboardController {
    ...
    @PostMapping("/ingress")
    public ResponseEntity<IngressDecision> ingress(@Valid @RequestBody UreqEnvelope env) {
